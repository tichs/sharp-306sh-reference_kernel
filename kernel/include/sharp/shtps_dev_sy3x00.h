...
#elif defined(CONFIG_SHTPS_SY3000_TM3054_001)
	#define SHTPS_TM_TXNUM_MAX		13
	#define SHTPS_TM_RXNUM_MAX		23
#else
	#define SHTPS_TM_TXNUM_MAX		20
	#define SHTPS_TM_RXNUM_MAX		10
#endif
...
#define F11_QUERY_HASQUERY27(data)							((data[0] >> 0x06) & 0x01)
#define F11_QUERY_HASQUERY28(data)							((data[0] >> 0x07) & 0x01)
...
#define F11_QUERY_HASZTUNING(data)							(data[6] & 0x01)
#define F11_QUERY_HASALGORITHMSELECTION(data)				((data[6] >> 1) & 0x01)
#define F11_QUERY_HASWTUNING(data)							((data[6] >> 2) & 0x01)
#define F11_QUERY_HASPITCHINFO(data)						((data[6] >> 3) & 0x01)
#define F11_QUERY_HASFINGERSIZE(data)						((data[6] >> 4) & 0x01)
#define F11_QUERY_HASSEGAGGRESSIVENESS(data)				((data[6] >> 5) & 0x01)
#define F11_QUERY_HASTXRXCLIP(data)							((data[6] >> 6) & 0x01)
#define F11_QUERY_HASDRUMMINGFILTER(data)					((data[6] >> 7) & 0x01)
#define F11_QUERY_HASSMALLOBJECTDETECTION(data)				(data[7] & 0x01)
#define F11_QUERY_HASSMALLOBJECTDETECTIONTUNING(data)		((data[7] >> 1) & 0x01)
#define F11_QUERY_HAS8BITW(data)							((data[7] >> 2) & 0x01)
#define F11_QUERY_HAS2DAJSTMAPPING(data)					((data[7] >> 3) & 0x01)
#define F11_QUERY_HASFINGERLIMIT(data)						((data[7] >> 6) & 0x01)
#define F11_QUERY_HASLINEARCOEFFICIENT2(data)				((data[7] >> 7) & 0x01)
#define F11_QUERY_HASPENPOSITIONCORRECTION(data)			((data[8] >> 1) & 0x01)
#define F11_QUERY_HASPENJITTERFILTERCOEFFICIENT(data)		((data[8] >> 2) & 0x01)
#define F11_QUERY_HASGROUPDECOMPOSITIONCONTROL(data)		((data[8] >> 3) & 0x01)
#define F11_QUERY_HASLPWG(data)								((data[8] >> 4) & 0x01)
#define F11_QUERY_HASSMALLFINGERCORRECTION(data)			((data[8] >> 5) & 0x01)
#define F11_QUERY_HASCTRL88(data)							(data[9] & 0x01)
#define F11_QUERY_HASCTRL92(data)							((data[9] >> 1) & 0x01)
#define F11_QUERY_HASCTRL89(data)							((data[9] >> 2) & 0x01)
#define F11_QUERY_HASCTRL90(data)							((data[9] >> 3) & 0x01)
#define F11_QUERY_HASDATA39(data)							((data[9] >> 4) & 0x01)
#define F11_QUERY_HASGLOVETUNING(data)						((data[9] >> 5) & 0x01)
#define F11_QUERY_HASADVANCEDFINGERTRACKING(data)			((data[9] >> 6) & 0x01)
#define F11_QUERY_HASLANDLOCK(data)							((data[9] >> 7) & 0x01)
#define F11_QUERY_SIZEOFCTRL92(data)						data[10]
#define F11_QUERY_HASLPWGDOUBLETAP(data)					(data[11] & 0x01)
#define F11_QUERY_HASLPWGSWIPE(data)						((data[11] >> 1) & 0x01)
#define F11_QUERY_HASLPWGSWIPEDISTANCE(data)				((data[11] >> 2) & 0x01)
#define F11_QUERY_HASDIRECTIONALSWIPE(data)					((data[11] >> 4) & 0x01)
#define F11_QUERY_HASLOWPOWERCONTROL(data)					((data[11] >> 5) & 0x01)
#define F11_QUERY_SIZEOFCTRL90(data)						data[12]
#define F11_QUERY_SIZEOFDATA39(data)						data[13]
#define F11_QUERY_HASAGGRESSIVEFINGERDISAMBIGUATION(data)	(data[14] & 0x01)
#define F11_QUERY_HASENHANCEDFINGERTRACKING(data)			((data[14] >> 1) & 0x01)
#define F11_QUERY_HASALTERNATEFINGERSORTING(data)			((data[14] >> 2) & 0x01)
#define F11_QUERY_HASCTRL99(data)							((data[14] >> 4) & 0x01)
