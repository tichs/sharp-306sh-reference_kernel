...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-004 */
#include <sharp/shspamp.h>
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 08-004 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-004 */
		if (spk ) {
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 08-004 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-003 */
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-004 */
...
#else	/* CONFIG_SH_AUDIO_DRIVER */ /* 08-003 */
			if ((msm8226_ext_spk_pamp & LO_1_SPK_AMP) &&
...
#endif	/* CONFIG_SH_AUDIO_DRIVER */ /* 08-003 */
		} else  {
