...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-082 */
#define WCD9XXX_CS_MEAS_DELTA_MAX_MV 36
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 08-082 */
#define WCD9XXX_CS_MEAS_DELTA_MAX_MV 12
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 08-082 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-078 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-059 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
                              (0xF0 | (ins ? (1 << 1) : 0)));
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 08-059 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
			      (0x68 | (ins ? (1 << 1) : 0)));
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 08-059 */
	else
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-059 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
                              (0xF4 | (ins ? (1 << 1) : 0)));
...
#ifndef CONFIG_SH_AUDIO_DRIVER /* 08-078 */
...
#endif /* CONFIG_SH_AUDIO_DRIVER *//* 08-078 */
...
irqreturn_t wcd9xxx_dce_handler(int irq, void *data)
{
	...
	void *calibration = mbhc->mbhc_cfg->calibration;
#if 0//def CONFIG_SH_AUDIO_DRIVER /* 08-005 */
	int temp;
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 08-005 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-040 */
...
#else
		if (!(snd_soc_read(codec, mbhc->mbhc_bias_regs.ctl_reg) & 0x80))
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 08-040 */
